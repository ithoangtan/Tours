...
BEGIN
	...
	SELECT sum(orders.totalPrice) as totalMonth FROM azmszdk4w6h5j1o6.orders 
		where orders.status = 'paid' 
		and orders.dateAdded >= v_timeFirst1
...
-- Dump completed on 2020-06-06 12:45:09
