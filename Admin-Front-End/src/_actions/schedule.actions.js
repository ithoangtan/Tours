import * as scheduleApis from "../_apis/schedule.api";
...
export const fetchScheduleByIdTourSuccess = data => {
   return {
      type: scheduleConstants.FETCH_SCHEDULE_GET_BYID_TOUR_SUCCESS,
      payload: {
         data
      }
   };
...
export const fetchScheduleByIdTourError = error => {
   return {
      type: scheduleConstants.FETCH_SCHEDULE_GET_BYID_TOUR_FAILED,
      payload: {
         error
      }
   };
