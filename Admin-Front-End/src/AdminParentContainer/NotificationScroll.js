                           ...
                           renderItem={item => (
                              ...
                              >
                                 <div className="ht-d-flex-row-space-between-baseline col-md-12">
                                    <div className="ht-icon-notice ht-d-flex-center-center col-md-1">
                                    ...
                                    <Tooltip title="Đánh dấu đã đọc">
                                       <Link className="ht-was-read ht-d-flex-center-center">
                                          <i className="far fa-check-circle ht-read"></i>
                                          <i className="far fa-check-circle ht-unread"></i>
                                       </Link>
                                    </Tooltip>
                                 </div>
                              </List.Item>
