          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-lg-3 ftco-animate">
                <div className="project">
                  <div className="img">
                    <img src="images/destination-5.jpg" className="img-fluid" alt="Colorlib Template" />
                  </div>
                  <div className="text">
                    <h4 className="price">$400</h4>
                    <span>15 Days Tour</span>
                  ...
                  <a href="images/destination-5.jpg" className="icon image-popup d-flex justify-content-center align-items-center">
                    <span className="icon-expand" />
                  </a>
                </div>
              </div>
              <div className="col-md-6 col-lg-3 ftco-animate">
                <div className="project">
                  <div className="img">
                    <img src="images/destination-6.jpg" className="img-fluid" alt="Colorlib Template" />
                  </div>
                  <div className="text">
                    <h4 className="price">$400</h4>
                    <span>15 Days Tour</span>
                  ...
                  <a href="images/destination-6.jpg" className="icon image-popup d-flex justify-content-center align-items-center">
                    <span className="icon-expand" />
                  </a>
                </div>
              </div>
              <div className="col-md-6 col-lg-3 ftco-animate">
                <div className="project">
                  <div className="img">
                    <img src="images/destination-7.jpg" className="img-fluid" alt="Colorlib Template" />
                  </div>
                  <div className="text">
                    <h4 className="price">$400</h4>
                    <span>15 Days Tour</span>
                  ...
                  <a href="images/destination-7.jpg" className="icon image-popup d-flex justify-content-center align-items-center">
                    <span className="icon-expand" />
                  </a>
                </div>
              </div>
              <div className="col-md-6 col-lg-3 ftco-animate">
                <div className="project">
                  <div className="img">
                    <img src="images/destination-8.jpg" className="img-fluid" alt="Colorlib Template" />
                  </div>
                  <div className="text">
                    <h4 className="price">$400</h4>
                    <span>15 Days Tour</span>
                  ...
                  <a href="images/destination-8.jpg" className="icon image-popup d-flex justify-content-center align-items-center">
                    <span className="icon-expand" />
                  </a>
                </div>
              </div>
              <div className="col-md-6 col-lg-3 ftco-animate">
                <div className="project">
                  <div className="img">
                    <img src="images/destination-9.jpg" className="img-fluid" alt="Colorlib Template" />
                  </div>
                  <div className="text">
                    <h4 className="price">$400</h4>
                    <span>15 Days Tour</span>
                  ...
                  <a href="images/destination-9.jpg" className="icon image-popup d-flex justify-content-center align-items-center">
                    <span className="icon-expand" />
                  </a>
                </div>
              </div>
              <div className="col-md-6 col-lg-3 ftco-animate">
                <div className="project">
                  <div className="img">
                    <img src="images/destination-10.jpg" className="img-fluid" alt="Colorlib Template" />
                  </div>
                  <div className="text">
                    <h4 className="price">$400</h4>
                    <span>15 Days Tour</span>
                  ...
                  <a href="images/destination-10.jpg" className="icon image-popup d-flex justify-content-center align-items-center">
                    <span className="icon-expand" />
                  </a>
                </div>
              </div>
              <div className="col-md-6 col-lg-3 ftco-animate">
                <div className="project">
                  <div className="img">
                    <img src="images/destination-11.jpg" className="img-fluid" alt="Colorlib Template" />
                  </div>
                  <div className="text">
                    <h4 className="price">$400</h4>
                    <span>15 Days Tour</span>
                  ...
                  <a href="images/destination-11.jpg" className="icon image-popup d-flex justify-content-center align-items-center">
                    <span className="icon-expand" />
                  </a>
                </div>
              </div>
              <div className="col-md-6 col-lg-3 ftco-animate">
                <div className="project">
                  <div className="img">
                    <img src="images/destination-12.jpg" className="img-fluid" alt="Colorlib Template" />
                  </div>
                  <div className="text">
                    <h4 className="price">$400</h4>
                    <span>15 Days Tour</span>
                  ...
                  <a href="images/destination-12.jpg" className="icon image-popup d-flex justify-content-center align-items-center">
                    <span className="icon-expand" />
                  </a>
                </div>
              </div>
